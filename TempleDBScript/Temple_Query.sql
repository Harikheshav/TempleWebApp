...
create table PoojaBkng(bkid int primary key identity(1,1),cost int,pooid int foreign key references Pooja(pid),det varchar(200),sdt datetime,edt datetime)
